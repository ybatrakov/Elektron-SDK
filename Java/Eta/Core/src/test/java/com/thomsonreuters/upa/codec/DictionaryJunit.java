...
public class DictionaryJunit
{
    ...
    public void loadFieldDictionaryTest()
    {
        ...
        assertEquals(CodecReturnCodes.SUCCESS, dictionary.loadFieldDictionary("src/test/resources/com/thomsonreuters/upa/data/Codec/RDMFieldDictionaryBoundary", error));
    ...
    public void loadEnumTypeDictionaryTest()
    {
        ...
        assertEquals(CodecReturnCodes.SUCCESS, dictionary.loadEnumTypeDictionary("src/test/resources/com/thomsonreuters/upa/data/Codec/enumtypeBoundary.def", error));
    ...
    public void loadZeroFidDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("src/test/resources/com/thomsonreuters/upa/data/Codec/RDMFieldDictionaryZeroFid", error));
    }
    ...
    public void loadInvalidRWFTypeDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("src/test/resources/com/thomsonreuters/upa/data/Codec/RDMFieldDictionaryInvalidRWFType", error));
    }
    ...
    public void loadDuplicateFidDictionaryTest()
    {
        ...
        // load field dictionary
        dictionary.clear();
        assertEquals(CodecReturnCodes.FAILURE, dictionary.loadFieldDictionary("src/test/resources/com/thomsonreuters/upa/data/Codec/RDMFieldDictionaryDuplicateFid", error));
    }
    ...
    public void decodeEnumTypeDictionaryFailureTest()
    {
        ...
        {
        	@Override
        	int decodeDictionaryTag(DecodeIterator iter, ElementEntryImpl element, int type, com.thomsonreuters.upa.transport.Error error)
            {
