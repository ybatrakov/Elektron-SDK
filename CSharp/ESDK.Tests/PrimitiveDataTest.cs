...
namespace CodecTestProject
{
    ...
    public class PrimitiveDataTest
    {
        ...
        public void RealStringTest()
        {
            ...
            tempDouble = System.Convert.ToDouble(realStr1);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
            testReal.Value(realStr2);
            tempDouble = System.Convert.ToDouble(realStr2);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
            testReal.Value(realStr3);
            tempDouble = System.Convert.ToDouble(realStr3);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
            testReal.Value(realStr4);
            tempDouble = System.Convert.ToDouble(realStr4);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
            testReal.Value(realStr5);
            tempDouble = System.Convert.ToDouble(realStr5);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
            ...
            tempDouble = System.Convert.ToDouble(realStr8);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
            testReal.Value(realStr9);
            tempDouble = System.Convert.ToDouble(realStr9);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
            testReal.Value(realStr10);
            tempDouble = System.Convert.ToDouble(realStr10);
            Assert.Equal(testReal.ToDouble(), tempDouble, 0);
            Assert.False(testReal.IsBlank);
        ...
        [Fact(Skip = "ByteBufferDontCare")]
        [Category("Unit")]
        public void StringConversionTest()
        {
            ByteBuffer testDataBuffer, testStrBuffer;
            Buffer testDataBuf = new Buffer(), testStrBuf = new Buffer();
            byte[] testData = Encoding.ASCII.GetBytes("Thomson Reuters Company");
            byte[] testString = new byte[128];
            byte[] testStringSmall = new byte[1];
            byte[] textData = Encoding.ASCII.GetBytes("test state text");
            ...
            Int testInt = new Int(), testIntOut = new Int();
            UInt testUInt = new UInt(), testUIntOut = new UInt();
            Float testFloat = new Float(), testFloatOut = new Float();
            Double testDouble = new Double(), testDoubleOut = new Double();
            Real testReal = new Real(), testRealOut = new Real();
            Date testDate = new Date(), testDateOut = new Date();
            Time testTime = new Time(), testTimeOut = new Time();
            DateTime testDateTime = new DateTime(), testDateTimeOut = new DateTime();
            Qos testQos = new Qos();
            State testState = new State();
            Enum testEnum = new Enum(), testEnumOut = new Enum();
            ByteBuffer buffer1;
            buffer1 = PutString("Thomson Reuters Company");
            Buffer testBuffer = new Buffer();
            testBuffer.Data(buffer1, 0, "Thomson Reuters Company".Length);
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testInt.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testInt, DataTypes.INT, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            ...
            Assert.Equal(testInt.ToString(), testIntOut.ToString());
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testUInt.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testUInt, DataTypes.UINT, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testUInt.ToString(), testUIntOut.ToString());
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testFloat.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testFloat, DataTypes.FLOAT, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testFloat.ToString(), testFloatOut.ToString());
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testDouble.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDouble, DataTypes.DOUBLE, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testDouble.ToString(), testDoubleOut.ToString());
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testReal.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testReal, DataTypes.REAL, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testReal.ToString(), testRealOut.ToString());
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testDate.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDate, DataTypes.DATE, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testDate.ToString(), testDateOut.ToString());
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testTime.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testTime, DataTypes.TIME, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testTime.ToString(), testTimeOut.ToString());


            /* Invalid time conversions start */
            /* Time conversion test */
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("-1:35:32:000:9:8"));
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("998:35:32:000:1000:1000"));
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("11:999:32:000:5:1"));
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("11:-12:32:000:5:1"));
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("11:2:999:000:5:1"));
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("11:2:-0:000:5:1"));
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("00:00:00:000:000:-1"));
            Assert.Equal(CodecReturnCode.INVALID_ARGUMENT, testTime.Value("23:35:32:000:-1:000"));
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testDateTime.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDateTime, DataTypes.DATETIME, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testDateTime.ToString(), testDateTimeOut.ToString());
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testQos.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testQos, DataTypes.QOS, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Buffer textDataBuffer = new Buffer();
            textDataBuffer.Data(textDataBuf);
            testState.Text(textDataBuffer);
            testDataBuf.Clear();
            testDataBuffer = PutString(testData.ToString());
            ByteBuffer tmp = new ByteBuffer(600);
            tmp.Put(testData);
            testDataBuffer = tmp;
            testDataBuf.Data(testDataBuffer);
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testState.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testState, DataTypes.STATE, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testEnum.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testEnum, DataTypes.ENUM, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            Assert.Equal(testEnum.ToString(), testEnumOut.ToString());

            /* Buffer conversion test */
            testDataBuf.Clear();
            testDataBuffer.Clear();
            testDataBuffer.Put(testData).Flip();
            testDataBuf.Data(testDataBuffer);
            encIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, encIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            Assert.Equal(CodecReturnCode.SUCCESS, testBuffer.Encode(encIter));
            decIter.Clear();
            Assert.Equal(CodecReturnCode.SUCCESS, decIter.SetBufferAndRWFVersion(testDataBuf, majorVersion, minorVersion));
            testStrBuf.Clear();
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDataBuf, DataTypes.BUFFER, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDataBuf, DataTypes.BUFFER, testStrBuf));
            Assert.True(testBuffer.Data().Equals(testStrBuf.Data()));
            ...
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDataBuf, DataTypes.ASCII_STRING, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDataBuf, DataTypes.UTF8_STRING, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
            ...
            testStrBuffer = PutString(testStringSmall.ToString());
            testStrBuf.Data(testStrBuffer);
            Assert.Equal(CodecReturnCode.SUCCESS, Decoders.PrimitiveToString(testDataBuf, DataTypes.RMTES_STRING, testStrBuf));
            /* should pass */
            testStrBuf.Clear();
            testStrBuffer = PutString(testString.ToString());
            testStrBuf.Data(testStrBuffer);
