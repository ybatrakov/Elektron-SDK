...
namespace ThomsonReuters.Eta.Transports.Tests
{
    public class ElementSetDefDbTest
    {
        ...
        public void elementSetDefEncDecTest()
        {
            ...
            buf.Data().Rewind();
            encIter.SetBufferAndRWFVersion(buf, ThomsonReuters.Eta.Codec.Codec.MajorVersion(), ThomsonReuters.Eta.Codec.Codec.MinorVersion());
            ...
            decIter.SetBufferAndRWFVersion(buf, ThomsonReuters.Eta.Codec.Codec.MajorVersion(), ThomsonReuters.Eta.Codec.Codec.MinorVersion());
