...
namespace ThomsonReuters.Eta.Transports
{
    ...
    /// <see cref="Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)"/> method call.
    ///
    ...
    public enum WriteFlags
    {
        ...
        /// <summary>
        /// No modification will be performed to this <see cref="Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)"/> operation.
        /// </summary>
        NO_FLAGS = 0x00,
