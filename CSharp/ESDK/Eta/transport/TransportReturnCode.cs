...
namespace ThomsonReuters.Eta.Transports
{
    ...
    public enum TransportReturnCode
    {
        ...
        ///
        /// Transport Success: Indicates that a <see cref="Transports.Interfaces.IChannel.Read(ReadArgs, out Error)"/>
        /// call on the <see cref="Transports.Interfaces.IChannel"/> is already in progress. 
       ...
       /// </summary>
        ...
        /// <see cref="Transports.Interfaces.IChannel.Read(ReadArgs, out Error)"/>
        /// </summary>
        READ_WOULD_BLOCK = -11,

        /// <summary>
        /// Transport Success:
        /// <see cref="Transports.Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)"/>
        ...
        /// <summary>
        /// Transport Success:
        /// <see cref="Transports.Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)"/> internally
        ...
        /// returned from <see cref="Transports.Interfaces.IChannel.GetBuffer(int, bool, out Error)"/>.
        /// </summary>
        NO_BUFFERS = -4,
        ...
        /// returned from <see cref="Transports.Interfaces.IChannel.Init(out Error)"/>
        /// </summary>
        CHAN_INIT_REFUSED = -2,
        ...
        /// <summary>
        /// Transport Success: Another <seealso cref="IChannel.Read(ReadArgs, out Error)"/> is needed to parse and get more message.
        /// </summary>
        READ_MORE_DATA = 1,

        /// <summary>
        /// Transport Success: Channel initialization is In progress, returned from
        /// <see cref="Transports.Interfaces.IChannel.Init(out Error)"/>
        /// </summary>
