...
{
    /// <summary>
    /// ETA Write Arguments used in the <see cref="Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)"/> call.
    ///
    /// <seealso cref="Interfaces.IChannel"/>
    ...
    {
        /// <summary>
        /// Priority to flush the message for <see cref="Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)"/>.
        /// <seealso cref="WritePriorities"/>
        /// </summary>
       ...
       /// <summary>
       /// Write flags used for <see cref = "Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)" />.
       /// <seealso cref="WriteFlags"/>
       /// </summary>
       /// <value>The flags</value>
        ...
        /// <summary>
        /// The sequence number of the message for <see cref="Interfaces.IChannel.Write(ITransportBuffer, WriteArgs, out Error)"/>.
        /// </summary>
