...
using ThomsonReuters.Eta.Common.Interfaces;

namespace ThomsonReuters.Eta.Common
{
    /// <summary>
    /// This class provides the ability to read and write data to byte array using network byte order.
    /// </summary>
    public class ByteBuffer : IDataBufferReader, IDataBufferWriter, IByteBuffer, IEquatable<ByteBuffer>, IDisposable
    {
#if DEBUG
...
#region Contents Manipulation
        ...
        public ByteBuffer Compact()
        {
            ...
            int remaining = Capacity - WritePosition;
            byte[] filler = new byte[remaining];
            Buffer.BlockCopy(filler, 0, Contents, WritePosition, remaining);
...
#region StreamWriter - Serialization
        ...
        /// <returns>This object</returns>
        public ByteBuffer WriteAt(int index, Int32 value)
        {
            byte[] buffer = BitConverter.GetBytes(System.Net.IPAddress.HostToNetworkOrder(value));
            Buffer.BlockCopy(buffer, 0, Contents, index, sizeof(int));
            return this;
        }
        ...
        /// <returns>This object</returns>
        public ByteBuffer WriteAt(int index, short value)
        {
            byte[] buffer = BitConverter.GetBytes(System.Net.IPAddress.HostToNetworkOrder(value));
            Buffer.BlockCopy(buffer, 0, Contents, index, sizeof(short));
            return this;
        }
        ...
        /// <returns>This object</returns>
        public ByteBuffer WriteAt(int index, long value)
        {
            byte[] buffer = BitConverter.GetBytes(System.Net.IPAddress.HostToNetworkOrder(value));
            Buffer.BlockCopy(buffer, 0, Contents, index, sizeof(long));
            return this;
        }
