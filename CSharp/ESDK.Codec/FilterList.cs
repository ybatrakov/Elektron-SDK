...
{
    /// <summary>
	/// The <seealso cref="FilterList"/> is a non-uniform container type of filterId - value
	/// pair entries. Each entry, known as a <seealso cref="FilterEntry"/>, contains an id
	...
	/// </para>
	/// <para>
	/// The following sample illustrates how to encode a <seealso cref="FilterList"/>
	/// containing a mixture of housed types. The example encodes three
	/// <seealso cref="FilterEntry"/> values:
	/// <ul>
	...
	///         // Continue encoding element entries. See <seealso cref="ElementList"/> for
	///         // element list
	///         // encoding example
	...
	/// 
	///         // Continue encoding map entries. See <seealso cref="Map"/> for encoding example.
	/// 
	///         // Complete nested container encoding
	/// 
	...
	/// </para>
	/// <para>
	/// The following sample illustrates how to decode a <seealso cref="FilterList"/> and is
	...
	/// example uses the same <seealso cref="DecodeIterator"/> when calling the content's
	/// decoder method. Optionally, an application could use a new
	/// <seealso cref="DecodeIterator"/> by setting the encData on a new iterator. To simplify
	...
	///                     // See <seealso cref="Map"/> for map decoding example.
	///                     break;
	///                 case DataTypes.ELEMENT_LIST:
	///                     retVal = elementList.Decode(decIter);
	///                     // Continue decoding element entries.
	///                     // See <seealso cref="ElementList"/> for element list decoding
	///                     // example.
	///                     break;
	...
	sealed public class FilterList : IXMLDecoder
    {
		...
		/// 2. Call one or more FilterEntry encoding methods using the same buffer<para />
		...
		/// stream. totalCountHint is used typically when multiple <seealso cref="FilterList"/>
		...
		/// would refer to the encoded <seealso cref="FilterList"/> payload.
		/// </summary>
		/// <returns> encodedEntries </returns>
