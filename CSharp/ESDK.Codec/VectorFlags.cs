...
namespace ThomsonReuters.Eta.Codec
{
	...
	public enum VectorFlags
	{
		...
		/// <summary>
		/// (0x01) Indicates that the <seealso cref="Vector"/> contains local set definition
		/// information. Local set definitions correspond to data contained in this
		/// <seealso cref="Vector"/>'s entries and are used for encoding or decoding.
		/// </summary>
		HAS_SET_DEFS = 0x01,

		/// <summary>
		/// (0x02) Indicates that the <seealso cref="Vector"/> contains summary data.
		/// <ul>
		...
		/// of <seealso cref="Vector"/> and the user can choose whether to decode it.</li>
		/// </ul>
		/// </summary>
		...
		/// entries. The <seealso cref="Vector"/> encoding functionality sets this flag value
		...
		/// <seealso cref="VectorEntryFlags.HAS_PERM_DATA"/>.
		/// </summary>
		...
		/// <summary>
		/// (0x10) Indicates that the <seealso cref="Vector"/> may leverage sortable action
		/// types. If a <seealso cref="Vector"/> is sortable, all components must properly
		...
		/// the corruption of the <seealso cref="Vector"/>'s contents.
		/// </summary>
