...
namespace ThomsonReuters.Eta.Codec
{
	...
	sealed public class DataTypes
	{
        ...
        /// <seealso cref="DataTypes.DATE"/> and <seealso cref="DataTypes.TIME"/>.
        /// </summary>
		...
		/// list (all primitive types except <seealso cref="Array"/>). The user can specify the
		...
		/// <seealso cref="Date"/> and hour, minute, and second from <seealso cref="Time"/>. This value
		/// can be represented as blank.
		/// </summary>
		...
		/// <seealso cref="Date"/> and hour, minute, second, and millisecond from <seealso cref="Time"/>. This value
		/// can be represented as blank.
		/// </summary>
		...
		/// <seealso cref="Date"/> and hour, minute, second, millisecond, and microsecond from <seealso cref="Time"/>. 
		/// This value can be represented as blank.
		/// </summary>
		...
		/// <seealso cref="Date"/> and hour, minute, second, millisecond, microsecond, and
		/// nanosecond from <seealso cref="Time"/>.   
		/// This value can be represented as blank.
		/// </summary>
		...
		/// dataType, and a value. This type is equivalent to <seealso cref="FieldList"/>, but
		/// without the optimizations provided through fieldId use.
		/// <para>
		/// <b>Entry Information</b>: Entry type is <seealso cref="ElementEntry"/>, which can
		/// house any <seealso cref="DataTypes"/>, including set-defined data, base primitive
		/// types, and container types.
		/// <ul>
		...
		/// <para>
		/// <b>Entry Information</b>: Entry type is <seealso cref="FilterEntry"/>, which can
		/// house only container types. Though the <seealso cref="FilterList"/> can specify a
		...
		/// specified on the <seealso cref="Vector"/>. Each entry's index is represented by an
		/// unsigned integer.
		/// <para>
		/// <b>Entry Information</b>: Entry type is <seealso cref="VectorEntry"/>, which can
		/// house only container types, as specified on the <seealso cref="Vector"/>. Each
		...
		/// <summary>
		/// A container of key-value paired entries. <seealso cref="Map"/> is a uniform type,
		/// where the base primitive type of each entry's key and the containerType
		/// of each entry's payload are specified on the <seealso cref="Map"/>.
		/// <para>
		/// <b>Entry Information</b>: Entry type is <seealso cref="MapEntry"/>, which can
		/// include only container types, as specified on the <seealso cref="Map"/>. Each
		/// entry's key is a base primitive type, as specified on the <seealso cref="Map"/>.
		...
		/// <seealso cref="Series"/>. This container is often used to represent table-based
		...
		/// <para>
		/// <b>Entry Information</b>: Entry type is <seealso cref="SeriesEntry"/>, which can
		/// include only container types, as specified on the <seealso cref="Series"/>.
		/// <seealso cref="SeriesEntry"/> types do not contain explicit actions; though as
		...
		/// </summary>
		/// <param name="dataType"> <seealso cref="DataTypes"/> enumeration to convert to string
		/// </param>
		...
		/// </summary>
		/// <param name="dataType"> <seealso cref="DataTypes"/> enumerated value to check
		/// </param>
		/// <returns> true if passed in type is a valid primitive type or false if not   </returns>
		...
		/// <param name="dataType"> <seealso cref="DataTypes"/> enumerated value to check
		/// </param>
		/// <returns> true if passed in type is a valid container type or false if not   </returns>
		...
		/// </summary>
		/// <param name="dataType"> <seealso cref="DataTypes"/> enumerated value to return encoded size for
		/// </param>
		/// <returns> maximum encoded size when this can be determined, 255 (0xFF) for types
		///         that contain buffer content whose length varies based on <seealso cref="Buffer.Length"/>,
		///         or 0 for invalid types   </returns>
