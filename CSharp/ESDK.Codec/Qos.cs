...
namespace ThomsonReuters.Eta.Codec
{
	...
	/// <li>An initial request containing both <seealso cref="IRequestMsg.Qos"/> and
	/// <seealso cref="IRequestMsg.WorstQos"/> sets the range of acceptable QoSs.</li>
	/// </ul>
	/// </para>
	/// <para>
	...
	/// <see cref="QosRates.TICK_BY_TICK"/></li>
	...
	sealed public class Qos : IEquatable<Qos>
	{
        ...
        /// <summary>
		/// Clears <seealso cref="Qos"/>. Useful for object reuse.
		/// </summary>
		public void Clear()
		{
		...
		///         <see cref="CodecReturnCode.INVALID_ARGUMENT"/> if the destQos is null.  </returns>
        ...
        /// </summary>
        /// <param name="iter"> <sees cref="EncodeIterator"/> with buffer to encode into. Iterator
		...
		/// Decode Qos.
		/// </summary>
		/// <param name="iter"> <sees cref="DecodeIterator"/> with buffer to decode from and
		///            appropriate version information set
		/// </param>
		/// <returns> <see cref="CodecReturnCode"/> . <see cref="CodecReturnCode.SUCCESS"/> if
		///         success, <see cref="CodecReturnCode.INCOMPLETE_DATA"/> if failure,
        ...
        /// <summary>
		/// Provide string representation for a <seealso cref="Qos"/> value.
		/// </summary>
		/// <returns> string representation for a <seealso cref="Qos"/> value </returns>
		...
		/// </param>
		/// <returns> true if the two Qos values are equal, false otherwise </returns>
		...
		/// <param name="thatQos"> the other Qos to compare to this one
		/// </param>
		/// <returns> true if Qos is better, false otherwise </returns>
		...
		/// </param>
		/// <returns> true if Qos is in range, false otherwise </returns>
        ...
        /// <summary>
		/// Information timeliness enum, from <seealso cref="QosTimeliness"/>. Used to convey
		...
		///         <seealso cref="CodecReturnCode.INVALID_ARGUMENT"/> if timeliness is invalid.  </returns>
		...
		/// </summary>
		/// <returns> the timeliness </returns>
        ...
        /// <summary>
		/// Information rate enum, from <seealso cref="QosRates"/>. Used to convey information
		/// about the data's period of change. Must be in the range of 0 - 15.
		/// </summary>
		/// <param name="rate"> the rate to set
		/// </param>
		/// <returns> <seealso cref="CodecReturnCode.SUCCESS"/> on success,
		///         <seealso cref="CodecReturnCode.INVALID_ARGUMENT"/> if rate is invalid.  </returns>
		...
		/// </param>
		/// <returns> <see cref="CodecReturnCode.SUCCESS"/> on success,
		///         <see cref="CodecReturnCode.INVALID_ARGUMENT"/> if timeInfo is invalid.  </returns>
        ...
        /// <summary>
		/// Specific timeliness information. Only present when timeliness is set to
		/// <seealso cref="QosTimeliness.DELAYED"/>.
		/// </summary>
		/// <returns> the timeInfo </returns>
		public int TimeInfo()
		{
			return _timeInfo;
		}
        ...
        /// </param>
        /// <returns> <see cref="CodecReturnCode.SUCCESS"/> on success,
        ///         <see cref="CodecReturnCode.INVALID_ARGUMENT"/> if rateInfo is invalid.  </returns>
