...
namespace ThomsonReuters.Eta.Codec
{
    ...
    /// presence of optional content for an <seealso cref="IAckMsg"/>.
    /// </summary>
    /// <seealso cref="ThomsonReuters.Eta.Codec.IAckMsg"/>
    public class AckMsgFlags
	{
		...
		/// <summary>
		/// (0x20) Indicates that Ack Message contains a NAK Code <seealso cref="NakCodes"/>. </summary>
