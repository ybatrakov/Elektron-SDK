...
namespace ThomsonReuters.Eta.Codec
{
	...
	sealed public class ElementSetDefEntry
	{
        ...
        /// </summary>
        /// <returns> ElementSetDefEntry object
        /// </returns>
        ...
        /// <summary>
		/// Clears members from an <seealso cref="ElementSetDefEntry"/>. Useful for object reuse.
		/// </summary>
        public void Clear()
		{
			_name.Clear();
		...
		/// structure as a <see cref="Buffer"/>. Element names are defined outside of ETA,
