...
namespace ThomsonReuters.Eta.Codec
{
    ...
    /// <seealso cref="Vector"/> can contain multiple set definitions via a set definition
    /// database with the contents of each <seealso cref="VectorEntry"/> requiring a different
    ...
    sealed public class GlobalFieldSetDefDb: FieldSetDefDb
	{
        ...
        /// <summary>
		/// Creates <seealso cref="GlobalFieldSetDefDb"/>.
		/// </summary>
		/// <returns> <seealso cref="GlobalFieldSetDefDb"/> object
		/// </returns>
        ...
        /// <summary>
        /// Clears <seealso cref="GlobalFieldSetDefDb"/> and all entries in it.
		...
		private CodecReturnCode DecodeDictionaryTag(DecodeIterator iter, ElementEntry element, int type, out CodecError error)
		{
			...
			else if (element._name.Equals(ElementNames.DICT_VERSION))
			{
				...
				ByteBuffer tmpByteBuffer = new ByteBuffer(tempBuffer.Length);
		...
		/// <param name="error">
		/// </param>
		/// <returns> <seealso cref="CodecReturnCode"/> </returns>
