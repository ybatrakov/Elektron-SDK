...
namespace ThomsonReuters.Eta.Codec
{
    ...
    /// </para>
    /// <para>
    /// Conversion of <seealso cref="Real"/> to double/float is performed by the following formula:
    /// </para>
    /// <para>
    /// <ul class="blockList">
    /// <li class="blockList">
    /// 
    /// <pre>
    /// if (<see cref="Real.Hint"/> lt; <seealso cref="FRACTION_1"/>)
    /// {
    ///      outputValue = Real.Value*(pow(10,(Real.Hint - <seealso cref="EXPONENT0"/>)));
    /// }
    /// else
    /// {
    ///      outputValue = Real.Value*(pow(2,(Real.Hint - <seealso cref="FRACTION_1"/>)));
    /// }
    /// </pre>
    /// </li>
    /// </ul>
    ...
    /// 
    /// <pre>
    /// if (inputHint lt; <seealso cref="FRACTION_1"/>)
    /// {
    ///      Real.Value = (inputValue)/(pow(10,(inputHint - <seealso cref="EXPONENT0"/>)));
    /// }
    /// else
    /// {
    ///      Real.Value = (inputValue)/(pow(2,(inputHint - <seealso cref="FRACTION_1"/>)));
    /// }
    /// </pre>
    /// </li>
    /// </ul>
