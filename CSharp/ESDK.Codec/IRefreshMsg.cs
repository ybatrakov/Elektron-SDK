...
namespace ThomsonReuters.Eta.Codec
{
	...
	public interface IRefreshMsg : IMsg
	{
		...
		/// <summary>
		/// The QoS of the stream. If a range was requested by the <seealso cref="IRequestMsg"/>
		...
		/// If present on a <seealso cref="IRefreshMsg"/>, this implies that this refresh was
