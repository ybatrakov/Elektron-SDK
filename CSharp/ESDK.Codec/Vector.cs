...
namespace ThomsonReuters.Eta.Codec
{
	...
	/// <seealso cref="Vector"/> can contain zero to N entries (zero entries indicates an empty
	/// <seealso cref="Vector"/>).
	/// 
	/// <para>
	...
	/// </para>
	/// <para>
	/// The following sample demonstrates how to encode a <seealso cref="Vector"/> containing
	/// <seealso cref="Series"/> values. The example encodes three <seealso cref="VectorEntry"/> values
	...
	/// </para>
	/// <para>
	/// The following sample illustrates how to decode a <seealso cref="Vector"/> and is
	/// structured to decode each entry to the contained value. This sample code
	/// assumes the housed container type is a <seealso cref="Series"/>. Typically an
	...
	sealed public class Vector : IXMLDecoder
    {
		...
		/// that applies to every entry encoded in the <seealso cref="Vector"/> (e.g. currency
		/// type). The container type of summary data must match the containerType
		/// specified on the <seealso cref="Vector"/>. If encodedSummaryData is populated while
		...
		/// multiple <seealso cref="Vector"/> containers are spread across multiple parts of a
