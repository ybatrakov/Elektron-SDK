...
namespace ThomsonReuters.Eta.Codec
{
	...
	sealed public class GlobalElementSetDefDb : ElementSetDefDb
    {
        ...
        /// </summary>
        /// <returns> <see cref="GlobalElementSetDefDb"/> object
        /// </returns>
        ...
        /// <summary>
        /// Clears <seealso cref="GlobalElementSetDefDb"/> and all entries in it. Useful for object reuse.
        /// </summary>
					...
					if (elemEntry._name.Equals(ElementNames.SET_NUMENTRIES))
					{
						...
						if (tempNameArray.Length != 0)
						{
							...
							while ((ret = arrEntry.Decode(iter)) != CodecReturnCode.END_OF_CONTAINER)
							{
								...
								tmpByteBuffer = new ByteBuffer(tempBuffer.Length);
