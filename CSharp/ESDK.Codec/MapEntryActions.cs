...
{
    /// <summary>
    /// Action to perform on a <seealso cref="Map"/> for the given map entry. The entry action
    ...
    public static class MapEntryActionsExtensions
    {
        ...
        /// </summary>
        /// <param name="mapEntryActions"> <seealso cref="MapEntryActions"/> enumeration to convert to string
        /// </param>
        /// <returns> string representation for a map entry action. </returns>
