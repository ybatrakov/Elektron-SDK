...
namespace ThomsonReuters.Eta.Codec
{
	...
	public class MsgClasses
	{
		...
		/// <summary>
		/// Consumers use <seealso cref="IRequestMsg"/> to express interest in a new stream or
		/// modify some parameters on an existing stream; typically results in the
		/// delivery of a <seealso cref="IRefreshMsg"/> or <seealso cref="IStatusMsg"/>.
		/// </summary>
		...
		/// <seealso cref="IStatusMsg"/> to close streams and to indicate successful
		...
		/// <summary>
		/// Interactive or NIPs use <seealso cref="IUpdateMsg"/> to convey changes to information on a stream.
		/// Update messages typically flow on a stream after delivery of a refresh
		/// </summary>
		public const int UPDATE = 4;

		/// <summary>
		/// A consumer uses <seealso cref="ICloseMsg"/> to indicate no further interest in a
		/// stream. As a result, the stream should be closed.
		/// </summary>
		public const int CLOSE = 5;

		/// <summary>
		/// A provider uses <seealso cref="IAckMsg"/> to inform a consumer of success or failure
		/// for a specific <seealso cref="IPostMsg"/> or <seealso cref="ICloseMsg"/>.
		/// </summary>
		...
		/// <summary>
		/// A consumer uses <seealso cref="IPostMsg"/> to push content upstream. This information
		...
		/// </param>
		/// <returns> the string representation of a message class </returns>
