...
namespace ThomsonReuters.Eta.Codec
{
	...
	public enum ElementListFlags
	{
        ...
        /// <summary>
        /// (0x02) Indicates that <seealso cref="ElementList"/> contains set-defined data.
        /// If both standard and set-defined data are present in this
        /// <seealso cref="ElementList"/>, this value can be set in addition to <seealso cref="ElementListFlags.HAS_STANDARD_DATA"/>.
        /// If no entries are present in the <seealso cref="ElementList"/>, do not set this flag value.
        /// </summary>
        HAS_SET_DATA = 0x02,

		/// <summary>
		/// (0x04) Indicates the presence of a setId and determines the set
		/// definition to use when encoding or decoding set data on this <seealso cref="ElementList"/>.
		/// </summary>
		HAS_SET_ID = 0x04,

        /// <summary>
        /// (0x08) Indicates that the <seealso cref="ElementList"/> contains standard element
        /// name, dataType, value-encoded data. You can set this value in addition to
        /// <seealso cref="ElementListFlags.HAS_SET_DATA"/> if both standard and set-defined data are present
        /// in this <seealso cref="ElementList"/>. If no entries are present in the
        /// <seealso cref="ElementList"/>, do not set this flag value.
        /// </summary>
