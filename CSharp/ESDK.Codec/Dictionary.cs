...
namespace ThomsonReuters.Eta.Rdm
{
    /// <summary>
    ...
    sealed public class Dictionary
	{
		...
		/// </summary>
		/// <seealso cref="ThomsonReuters.Eta.Codec.DataDictionary"/>
		public class Types
		{
        ...
        /// desired. These values are typically set in a <seealso cref="IRequestMsg"/>'s
        /// <seealso cref="MsgKey"/> filter when the request for the dictionary is made.
