...
namespace ThomsonReuters.Eta.Codec
{
	...
	public class StreamStates
	{
		...
		/// final <seealso cref="IRefreshMsg"/> or <seealso cref="IStatusMsg"/>.
		/// </summary>
		public const int OPEN = 1;

		/// <summary>
		/// Request was non-streaming. After final <seealso cref="IRefreshMsg"/> or
		/// <seealso cref="IStatusMsg"/> is received, the stream will be closed and no updated
		...
		/// occur via either a <seealso cref="IRefreshMsg"/> or a <seealso cref="IStatusMsg"/>.
		/// </summary>
		...
		/// </summary>
		/// <param name="streamState"> <seealso cref="StreamStates"/> enumeration to convert to string
		/// </param>
		/// <returns> string representation for a stream state value </returns>
		...
		/// </summary>
		/// <param name="streamState"> <seealso cref="StreamStates"/> enumeration to get info for
		/// </param>
		/// <returns> string representation of meaning associated with stream state </returns>
