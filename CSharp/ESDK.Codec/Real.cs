...
namespace ThomsonReuters.Eta.Codec
{
	...
	/// 
	/// Typical Use:<para />
	/// User populates value with signed value and format with <see cref="RealHints"/>.<para />
	/// If format hint is in Exponent Range (0 - 14) value * 10^(format - 14)<para />
	/// If format hint is in Fraction Range (22 - 30) value * (1/2)^(format - 22)<para />
	/// 
	...
	sealed public class Real
	{
		...
		///         <seealso cref="CodecReturnCode.INVALID_ARGUMENT"/> if the destReal is null.  </returns>
		...
		///         <see cref="CodecReturnCode.INVALID_ARGUMENT"/> if value or hint is invalid.  </returns>
        ...
        /// <summary>
		/// Populated with an enumerated value from <seealso cref="RealHints"/>.
		...
		{
			return Encoders.PrimitiveEncoder.EncodeReal((EncodeIterator)iter, this);
		}
		...
		/// </summary>
		/// <returns> the string representation of this <seealso cref="Real"/> </returns>
        ...
        /// <summary>
		/// Convert String to a <seealso cref="Real"/>.
		/// </summary>
		/// <param name="value"> String to convert to <seealso cref="Real"/>
		/// </param>
		/// <returns> <seealso cref="CodecReturnCode.SUCCESS"/> on success,
