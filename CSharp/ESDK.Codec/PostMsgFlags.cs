...
namespace ThomsonReuters.Eta.Codec
{
	...
	public class PostMsgFlags
	{
		...
		/// <summary>
		/// (0x004) Indicates that the <seealso cref="IPostMsg"/> contains a populated msgKey that
		...
		/// <summary>
		/// (0x040) Specifies that the consumer wants the provider to send an <seealso cref="IAckMsg"/>
		/// to indicate that the <seealso cref="IPostMsg"/> was processed properly. When
		/// acknowledging a <seealso cref="IPostMsg"/>, the provider will include the postId in
