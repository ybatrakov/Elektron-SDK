...
namespace ThomsonReuters.Eta.Codec
{
	...
	/// <seealso cref="FieldEntry"/>. A field identifier, also referred to as a fieldId, is a
	...
	/// </para>
	/// <para>
	/// The following example demonstrates how to encode a <seealso cref="FieldList"/> and
	/// encodes four <seealso cref="FieldEntry"/> values:
	/// <ul>
	/// <li>
	/// The first encodes an entry from a primitive <seealso cref="Date"/> type.</li>
	/// <li>
	/// The second from a pre-encoded buffer containing an encoded <seealso cref="UInt"/>.</li>
	/// <li>
	/// The third as a blank <seealso cref="Real"/> value.</li>
	/// <li>
	/// The fourth as an <seealso cref="Array"/> complex type. The pattern followed while
	/// encoding the fourth entry can be used for encoding of any container type into
	/// a <seealso cref="FieldEntry"/></li>
	/// </ul>
	/// </para>
	/// <para>
	...
	/// </para>
	/// <para>
	/// The following example demonstrates how to decode a <seealso cref="FieldList"/> and is
	...
	/// omitted. This example uses the same <seealso cref="DecodeIterator"/> when calling the
	/// primitive decoder method. An application could optionally use a new
	/// <seealso cref="DecodeIterator"/> by setting the encData on a new iterator.
	/// 
	/// </para>
	/// <para>
	/// <ul class="blockList">
	...
	sealed public class FieldList : IXMLDecoder
    {
		...
		/// the list using the same buffer<para />
		...
		/// 
		/// Typical use:<para />
		/// 1. Call FieldList.Decode()<para />
		/// 2. Call FieldEntry.Decode() for each field in the list.<para />
		/// </summary>
		...
		{
            Flags = (Flags | FieldListFlags.HAS_FIELD_LIST_INFO);
		}
		...
		{
            Flags = (Flags | FieldListFlags.HAS_STANDARD_DATA);
		}
		...
		{
            Flags = (Flags | FieldListFlags.HAS_SET_ID);
		}
		...
		{
            Flags = (Flags | FieldListFlags.HAS_SET_DATA);
		}
        ...
        /// RDMFieldDictionary.
        /// </summary>
        /// <returns> the dictionaryId </returns>
		...
		/// </summary>
		/// <returns> the encodedSetData </returns>
		...
		/// <seealso cref="FieldList"/> payload and length information.
		/// </summary>
