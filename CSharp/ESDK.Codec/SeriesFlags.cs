...
{
	/// <summary>
	/// A combination of bit values that indicates the presence of optional <seealso cref="Series"/> content.
	/// </summary>
	/// <seealso cref="Series"/>
	public enum SeriesFlags
	{
		...
		/// <summary>
		/// (0x01) Indicates that the <seealso cref="Series"/> contains local set definition
		...
		/// <summary>
		/// (0x02) Indicates that the <seealso cref="Series"/> contains summary data.
		/// <ul>
		...
		/// <seealso cref="Series"/> and the user can choose to decode it.</li>
		/// </ul>
		/// </summary>
