...
{
    /// <summary>
	/// Consumers use <seealso cref="Priority"/> to indicate the stream's level of importance,
	...
	/// </para>
	/// <para>
	/// Because priority information is optional on a <seealso cref="IRequestMsg"/>:
	/// <ul>
	...
	sealed public class Priority
	{
        ...
        /// <summary>
        /// Clears <seealso cref="Priority"/>. Useful for object reuse.
        /// </summary>
        public void Clear()
		{
            PriorityClass = 0;
