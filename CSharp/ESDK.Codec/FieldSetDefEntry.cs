...
namespace ThomsonReuters.Eta.Codec
{
    ...
    sealed public class FieldSetDefEntry
    {
		...
		/// </summary>
		/// <returns> FieldSetDefEntry object
		/// </returns>
        ...
        /// <summary>
		/// Clears members from a <seealso cref="FieldSetDefEntry"/>. Useful for object reuse.
		/// </summary>
        public void Clear()
        {
            FieldId = 0;
		...
		/// the set-defined <seealso cref="FieldList"/> content. Refers to specific name and
