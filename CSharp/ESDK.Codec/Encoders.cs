...
namespace ThomsonReuters.Eta.Codec
{
	internal class Encoders
	{
        ...
        public class PrimitiveEncoder
		{
            ...
            private static readonly HashSet<int> _primitveDataTypesSet = new HashSet<int>();
            ...
            public static CodecReturnCode SetEncodeActions(int type, EncodeIterator iter, object data)
            {
                ...
                {
                    case 3:
                        return EncodeIntWithLength(iter, (Int)data);
                    case 4:
                        return EncodeUIntWithLength(iter, (UInt)data);
                    case 5:
                        return EncodeFloatWithLength(iter, (Float)data);
                    case 6:
                        return EncodeDoubleWithLength(iter, (Double)data);
                    case 8:
                        return EncodeRealWithLength(iter, (Real)data);
                    case 9:
                        return EncodeDateWithLength(iter, (Date)data);
                    case 10:
                        return EncodeTimeWithLength(iter, (Time)data);
                    case 11:
                        return EncodeDateTimeWithLength(iter, (DateTime)data);
                    case 12:
                        return EncodeQosWithLength(iter, (Qos)data);
                    case 13:
                        return EncodeStateWithLength(iter, (State)data);
                    case 14:
                        return EncodeEnumWithLength(iter, (Enum)data);
                    case 16:
                    case 17:
                    case 18:
                    case 19:
                        return EncodeBufferWithLength(iter, (Buffer)data);
                    case 64:
                        return EncodeInt1(iter, (Int)data);
                    case 65:
                        return EncodeUInt1(iter, (UInt)data);
                    case 66:
                        return EncodeInt2(iter, (Int)data);
                    case 67:
                        return EncodeUInt2(iter, (UInt)data);
                    case 68:
                        return EncodeInt4(iter, (Int)data);
                    case 69:
                        return EncodeUInt4(iter, (UInt)data);
                    case 70:
                        return EncodeInt8(iter, (Int)data);
                    case 71:
                        return EncodeUInt8(iter, (UInt)data);
                    case 72:
                        return EncodeFloat4(iter, (Float)data);
                    case 73:
                        return EncodeDouble8(iter, (Double)data);
                    case 74:
                        return EncodeReal4(iter, (Real)data);
                    case 75:
                        return EncodeReal8(iter, (Real)data);
                    case 76:
                        return EncodeDate4(iter, (Date)data);
                    case 77:
                        return EncodeTime3(iter, (Time)data);
                    case 78:
                        return EncodeTime5(iter, (Time)data);
                    case 79:
                        return EncodeDateTime7(iter, (DateTime)data);
                    case 80:
                        return EncodeDateTime9(iter, (DateTime)data);
                    case 81:
                        return EncodeDateTime11(iter, (DateTime)data);
                    case 82:
                        return EncodeDateTime12(iter, (DateTime)data);
                    case 83:
                        return EncodeTime7(iter, (Time)data);
                    case 84:
                        return EncodeTime8(iter, (Time)data);
                }
        ...
        public static CodecReturnCode EncodeMsg(EncodeIterator iterInt, IMsg msg)
        {
            CodecReturnCode ret;
            int headerSize;
            EncodingLevel _levelInfo;
            EncodeIterator iter = (EncodeIterator)iterInt;
        ...
        public static CodecReturnCode EncodeMsgInit(EncodeIterator iterInt, IMsg msg, int dataMaxSize)
        {
        ...
        public static CodecReturnCode EncodeMsgComplete(EncodeIterator iterInt, bool success)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeMsgKeyAttribComplete(EncodeIterator iterInt, bool success)
        {
            CodecReturnCode ret;
            int headerSize;
            EncodeIterator iter = (EncodeIterator)iterInt;
        ...
        internal static CodecReturnCode EncodeExtendedHeaderComplete(EncodeIterator iterInt, bool success)
        {
            CodecReturnCode ret;
            int size;
            int headerSize;
        ...
        internal static CodecReturnCode EncodeElementListInit(EncodeIterator iterInt, ElementList elementListInt, LocalElementSetDefDb setDbInt, int setEncodingMaxSize)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            Debug.Assert(null != elementListInt, "Invalid elementListInt in as NULL");

            EncodingLevel levelInfo;
            int setId;
            EncodeIterator iter = (EncodeIterator)iterInt;
            LocalElementSetDefDb setDb = setDbInt;
            ...
            if (elementList.CheckHasSetData())
            {
                ...
                if (elementList.CheckHasSetId())
                {
                    ...
                    if (elementList.SetId < 0x80)
                    {
                        ...
                        iter._writer.WriteByte(elementList.SetId);
                    }
                    else
                    {
                        if (iter.IsIteratorOverrun(2))
        ...
        public static CodecReturnCode EncodeElementListComplete(EncodeIterator iterInt, bool success)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        public static CodecReturnCode EncodeElementEntry(EncodeIterator iterInt, ElementEntry elementInt, object data)
        {
        ...
        public static CodecReturnCode EncodeElementEntryInit(EncodeIterator iterInt, ElementEntry elementInt, int encodingMaxSize)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
            ElementEntry element = elementInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        public static CodecReturnCode EncodeElementEntryComplete(EncodeIterator iterInt, bool success)
        {
            CodecReturnCode ret;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeFieldListInit(EncodeIterator iterInt, FieldList fieldListInt, LocalFieldSetDefDb localFieldFidDb,int setEncodingMaxSize)
		{
            CodecReturnCode ret;
			EncodingLevel levelInfo;
			int setId;
			...
			/* Store flags as UInt8 */
			iter._writer.WriteByte((int)fieldList.Flags);
			iter._curBufPos = iter._writer.Position();
			...
			if (fieldList.CheckHasInfo())
			{
				...
				if (fieldList.DictionaryId < 0x80)
				{
					...
					iter._writer.WriteByte(fieldList.DictionaryId);
				}
				else
				{
			...
			if (fieldList.CheckHasSetData())
			{
				...
				if (fieldList.CheckHasSetId())
				{
					if (fieldList.SetId < 0x80)
					{
						...
						iter._writer.WriteByte(fieldList.SetId);
					}
					else
					{
						if (iter.IsIteratorOverrun(2))
		...
		public static CodecReturnCode EncodeFieldListComplete(EncodeIterator iterInt, bool success)
		{
			EncodeIterator iter = (EncodeIterator)iterInt;
			EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
		...
		internal static CodecReturnCode EncodeFieldEntry(EncodeIterator iterInt, FieldEntry fieldInt, object data)
		{
            CodecReturnCode ret;
			EncodeIterator iter = (EncodeIterator)iterInt;
		...
		internal static CodecReturnCode EncodeFieldEntryInit(EncodeIterator iterInt, FieldEntry fieldInt, int encodingMaxSize)
		{
			EncodeIterator iter = (EncodeIterator)iterInt;
			FieldEntry field = (FieldEntry)fieldInt;
			EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
		...
		internal static CodecReturnCode EncodeFieldEntryComplete(EncodeIterator iterInt, bool success)
		{
            CodecReturnCode ret;
			EncodeIterator iter = (EncodeIterator)iterInt;
			EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeArrayInit(EncodeIterator iterInt, Array arrayInt)
        {
        ...
        internal static CodecReturnCode EncodeArrayEntry(EncodeIterator iterInt, object data)
        {
            Array array;
                ...
                case DataTypes.RMTES_STRING:
                    ...
                    else
                    {
                        ...
                        if (buffer.Length < array._itemLength)
                        {
                            ...
                            {
                                iter._writer.WriteByte((buffer).DataByte(buffer.Position + i));
                            }
        ...
        internal static CodecReturnCode EncodePreencodedArrayEntry(EncodeIterator iterInt, Buffer encodedData)
        {
            CodecReturnCode ret = CodecReturnCode.SUCCESS;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeArrayComplete(EncodeIterator iterInt, bool success)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
		...
		internal static CodecReturnCode EncodeNonRWFInit(EncodeIterator iterInt, Buffer buffer)
		{
			EncodingLevel levelInfo;
			EncodeIterator iter = (EncodeIterator)iterInt;
		...
		internal static CodecReturnCode EncodeNonRWFComplete(EncodeIterator iterInt, Buffer buffer, bool success)
		{
			EncodeIterator iter = (EncodeIterator)iterInt;
			EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
			...
			if (success)
			{
				...
				iter._curBufPos += (int)buffer.Data().Position - (buffer).Position;
				iter._writer.Position(iter._curBufPos);
			}
			else
			{
        ...
        internal static CodecReturnCode EncodeFilterListInit(EncodeIterator iterInt, FilterList filterListInt)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            Debug.Assert(null != filterListInt, "Invalid filterListInt in as NULL");

            EncodingLevel _levelInfo;
            int flags;
            EncodeIterator iter = (EncodeIterator)iterInt;
            FilterList filterList = filterListInt;
        ...
        internal static CodecReturnCode EncodeFilterListComplete(EncodeIterator iterInt, bool success, FilterList filterListInt)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
            FilterList filterList = filterListInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeFilterEntryInit(EncodeIterator iterInt, FilterEntry entry, int size)
        {
            CodecReturnCode ret = CodecReturnCode.SUCCESS;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeFilterEntryComplete(EncodeIterator iterInt, bool success)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            EncodeIterator iter = (EncodeIterator)iterInt;
            CodecReturnCode ret;
        ...
        internal static CodecReturnCode EncodeFilterEntry(EncodeIterator iterInt, FilterEntry filterEntryInt)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            Debug.Assert(null != filterEntryInt, "Invalid filterEntryInt in as NULL");
        ...
        internal static CodecReturnCode EncodeMapInit(EncodeIterator iterInt, Map mapInt, int summaryMaxSize, int setMaxSize)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
        ...
        internal static CodecReturnCode EncodeMapComplete(EncodeIterator iterInt, Map mapInt, bool success)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
            Map map = mapInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeMapSummaryDataComplete(EncodeIterator iterInt, Map mapInt, bool success)
        {
            CodecReturnCode ret;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeMapEntryInit(EncodeIterator iterInt, MapEntry mapEntryInt, object keyData, int maxEncodingSize)
        {
            CodecReturnCode ret;
            Map map;
            EncodeIterator iter = (EncodeIterator)iterInt;
        ...
        internal static CodecReturnCode EncodeMapEntryComplete(EncodeIterator iterInt, MapEntry mapEntryInt, bool success)
        {
            CodecReturnCode ret;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeMapEntry(EncodeIterator iterInt, MapEntry mapEntryInt, object keyData)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            Debug.Assert(null != mapEntryInt, "Invalid mapEntryInt in as NULL");
        ...
        internal static CodecReturnCode EncodeSeriesInit(EncodeIterator iterInt, Series seriesInt, int summaryMaxSize, int setMaxSize)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            Debug.Assert(null != seriesInt, "Invalid seriesInt in as NULL");

            EncodeIterator iter = (EncodeIterator)iterInt;
            Series series = seriesInt;
            EncodingLevel _levelInfo;
        ...
        internal static CodecReturnCode EncodeSeriesComplete(EncodeIterator iterInt, bool success)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
        ...
        internal static CodecReturnCode EncodeSeriesEntryInit(EncodeIterator iterInt, SeriesEntry seriesEntryInt, int maxEncodingSize)
        {
            Series series;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
            ...
            /* Validations */
            Debug.Assert(null != iter && null != seriesEntryInt, "Invalid parameters or parameters passed in as NULL");
            Debug.Assert(_levelInfo._containerType == DataTypes.SERIES, "Invalid encoding attempted - wrong type");
            Debug.Assert(_levelInfo._encodingState == EncodeIteratorStates.ENTRIES, "Unexpected encoding attempted");
        ...
        internal static CodecReturnCode EncodeSeriesEntryComplete(EncodeIterator iterInt, bool success)
        {
            CodecReturnCode ret;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeSeriesEntry(EncodeIterator iterInt, SeriesEntry seriesEntryInt)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
        ...
        internal static CodecReturnCode EncodeVectorInit(EncodeIterator iterInt, Vector vectorInt, int summaryMaxSize, int setMaxSize)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
        ...
        internal static CodecReturnCode EncodeVectorComplete(EncodeIterator iterInt, bool success, Vector vectorInt)
        {
            EncodeIterator iter = (EncodeIterator)iterInt;
            Vector vector = vectorInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeVectorSummaryDataComplete(EncodeIterator iterInt, Vector vectorInt, bool success)
        {
            CodecReturnCode ret;
            EncodeIterator iter = (EncodeIterator)iterInt;
            Vector vector = vectorInt;
        ...
        // Part 8
        internal static CodecReturnCode EncodeVectorEntryInit(EncodeIterator iterInt, VectorEntry vectorEntryInt, int maxEncodingSize)
        {
            CodecReturnCode ret;
            Vector vector;
            EncodeIterator iter = (EncodeIterator)iterInt;
        ...
        internal static CodecReturnCode EncodeVectorEntry(EncodeIterator iterInt, VectorEntry vectorEntryInt)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            Debug.Assert(null != vectorEntryInt, "Invalid vectorEntryInt in as NULL");
        ...
        internal static CodecReturnCode EncodeVectorEntryComplete(EncodeIterator iterInt, bool success)
        {
            CodecReturnCode ret;
            EncodeIterator iter = (EncodeIterator)iterInt;
            EncodingLevel _levelInfo = iter._levelInfo[iter._encodingLevel];
        ...
        internal static CodecReturnCode EncodeLocalElementSetDefDb(EncodeIterator iterInt, LocalElementSetDefDb setDb)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
        ...
        internal static CodecReturnCode EncodeSeriesSetDefsComplete(EncodeIterator iterInt, bool success)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
        ...
        internal static CodecReturnCode EncodeSeriesSummaryDataComplete(EncodeIterator iterInt, bool success)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
        ...
        internal static CodecReturnCode EncodeMapSetDefsComplete(EncodeIterator iterInt, bool success)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
        ...
        internal static CodecReturnCode EncodeVectorSetDefsComplete(EncodeIterator iterInt, bool success)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
        ...
        internal static CodecReturnCode EncodeLocalFieldSetDefDb(EncodeIterator iterInt, LocalFieldSetDefDb setDb)
        {
            Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
            Debug.Assert(null != setDb, "Invalid setDb in as NULL");
        ...
        internal static CodecReturnCode EncodeFieldSetDefDb(EncodeIterator iterInt, FieldSetDefDb setDb)
		{
			Debug.Assert(null != iterInt, "Invalid IterInt in as NULL");
			Debug.Assert(null != setDb, "Invalid setDb in as NULL");
