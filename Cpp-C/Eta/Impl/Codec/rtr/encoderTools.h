									...
									char				*position )
{
	...
	dataLength = position - pMark->_sizePtr - pMark->_sizeBytes;
...
//RTR_C_INLINE char* _rsslSetupU32Mark(RsslEncodeSizeMark	*pMark,
//									RsslUInt32			maxSize,
//									char				*position )
//{
//	RSSL_ASSERT(position != 0, Invalid encoding attempted);
...
//
//	pMark->_sizePtr = position;
//	if ((maxSize == 0) || (maxSize > RWF_MAX_16))
//	{
//		pMark->_sizeBytes = 5;
//		position += 5;
//	}
//	else if (maxSize >= 0xFE)
//	{
//		pMark->_sizeBytes = 3;
//		position += 3;
//	}
...
//}
//
//RTR_C_INLINE RsslRet _rsslFinishU32Mark(RsslEncodeSizeMark	*pMark,
//										char				*position )
//{
//	RsslUInt32 dataLength;
//
...
//		rwfPut8( pMark->_sizePtr, tmp8 );
//	}
//	else if (pMark->_sizeBytes == 3)
//	{
//		RsslUInt16 tmp16 = (RsslUInt16)dataLength;
//		if (dataLength > RWF_MAX_16)
//			return RSSL_RET_INVALID_DATA;
//		*(pMark->_sizePtr) = 0xFE;
//		rwfPut16( (pMark->_sizePtr + 1), tmp16);
//	}
//	else
//	{
//		RSSL_ASSERT(pMark->_sizeBytes == 5, Invalid encoding attempted);
//		if (dataLength > RWF_MAX_32)
//			return RSSL_RET_INVALID_DATA;
//		*(pMark->_sizePtr) = 0xFF;
//		rwfPut32((pMark->_sizePtr + 1), dataLength);
//	}
//
//	pMark->_sizePtr = 0;
//	return RSSL_RET_SUCCESS;
...
//ETAC_OPEN_SOURCE_DOUBLE_CHECK
//RTR_C_INLINE char * _rsslEncodeBuffer32(char *position, const RsslBuffer * buffer)
//{
//	RsslUInt32 tlen = (RsslUInt32)buffer->length;
//	position += RWF_PUT_OPTBYTE_U32( position, &tlen);
//	MemCopyByInt( position, buffer->data, tlen);
//	position += tlen;
//	return position;
//}
...
//ETAC_OPEN_SOURCE_DOUBLE_CHECK
//#define	_RSSL_VALID_RESBIT_15(X)	(((X) & ( RsslUInt16)0x8000 ) == 0 )
//#define	_RSSL_VALID_RESBIT_30(X)	(((X) & ( RsslUInt32)0xC0000000 ) == 0 )
//#define	_RSSL_VALID_RESBIT_31(X)	(((X) & ( RsslUInt32)0x80000000 ) == 0 )
//
//#ifdef _WIN32
//#define	_RSSL_VALID_RESBIT_62(X)	(((X) & 0xC000000000000000i64 ) == 0 )
//#else
//#define	_RSSL_VALID_RESBIT_62(X)	(((X) & 0xC000000000000000ULL ) == 0 )
//#endif
//
//
//#ifdef		_WIN32
//	#include	<malloc.h>
//	#define		_RSSL_ALLOCA						_alloca
//#else
//	#include	<stdlib.h>
//	#define		_RSSL_ALLOCA						alloca
//#endif 
