...
const extern int SHAPE_94;
const extern int SHAPE_96;
...
const extern RsslRmtesCharSet _rsslReuterBasic1;
const extern RsslRmtesCharSet _rsslReuterBasic2;
const extern RsslRmtesCharSet _rsslJapaneseKatakana;
const extern RsslRmtesCharSet _rsslJapaneseLatin;
const extern RsslRmtesCharSet _rsslJapaneseKanji;
const extern RsslRmtesCharSet _rsslChinese1;
const extern RsslRmtesCharSet _rsslChinese2;
