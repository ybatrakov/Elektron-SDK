...
const RsslRmtesCharSet _rsslReuterBasic1 = {0, 0, 94, 94, 0, 1};
const RsslRmtesCharSet _rsslReuterBasic2 = {rsslcnvtab_rbcs2, rsslcnvtab_rbcs2_br, 94, 94, 63, 1};
const RsslRmtesCharSet _rsslJapaneseKatakana = {rsslcnvtab_katakana, 0, 94, 63, 0, 1};
const RsslRmtesCharSet _rsslJapaneseLatin = {rsslcnvtab_romaji, 0, 94, 94, 0, 1};
