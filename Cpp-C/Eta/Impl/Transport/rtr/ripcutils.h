...
//#define ripcPackBitmap ripc10PackBitmap - not used
//#define ripcUnpackBitmap ripc10UnpackBitmap - not used

//#define ripcValidServerName ripc10ValidServerName
//#define ripcGetServByName ripc10GetServByName

//#define ripcSockOpts ripc10SockOpts
//#define ripcBindSocket ripc10BindSocket
//#define ripcProtocolNum ripc10ProtocolNum
//#define ripcSocketLimit ripc10SocketLimit - not used
//#define ripcRead ripc10Read
//#define ripcWrite ripc10Write
//#define ripcReadyWrite ripc10ReadyWrite
//#define ripcReadyRead ripc10ReadyRead
//#define ripcReadyException ripc10ReadyException
//#define ripcConnected ripc10Connected


extern int ripcValidServerName(char *name, int nlen);
extern int ripcGetServByName(char *serv_name);
extern int ipcSockOpts( RsslSocket fd, ripcSocketOption *option );
//
extern int ripcBindSocket(u32 ipaddr, int portNum, RsslSocket fd);
extern int ripcProtocolNum(char* type);
extern int ripcSocketLimit();
extern int ripcReadyWrite(RsslSocket fd);
extern int ipcReadyRead(RsslSocket fd);
extern int ripcReadyException(RsslSocket fd);
