...
//#define ripcInitializeWinInet ripc11InitializeWinInet

//#define ripcWinInetRead ripc11WinInetRead
//#define ripcWinInetWrite ripc11WinInetWrite
//#define ripcShutdownWinInetSocket ripc11ShutdownWinInetSocket
//#define ripcInitializeWinInetSession ripc11InitializeWinInetSession
//#define ripcWinInetConnect ripc11WinInetConnect
//#define ripcReleaseWinInetSession ripc11ReleaseWinInetSession
//#define ripcWinInetInitConnection ripc11WinInetInitConnection
//#define ripcWinInetCreatePipe ripc11WinInetCreatePipe
//#define ripcWinInetReconnection ripc11WinInetReconnection
//#define ripcWinInetIoctl ripcWinInetIoctl
...
RTR_C_INLINE RsslRet initRipcWinInet()
{
	...
	retVal = ripcSetTransFunc(RSSL_CONN_TYPE_HTTP, &winInetfuncs);
...
RTR_C_INLINE ripcWinInetSession *ripcWinInetNewSession(RsslSocket fd, char* name, RsslError *error)
{
	...
	RTR_MUTEX_INIT( session->tunnelMutex, mterr );
