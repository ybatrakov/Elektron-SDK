...
//#define FD_BITMAP	fd_set      /* for compatibility */
#define sock_close	close       /* for compatibility */
//#define sock_select	select      /* for compatibility */
...
#define RIPC_COMP_FORCE		0x80	/* force compression for connection level */
...
#define RIPC_COMP_BYTEINDEX 0
#define RIPC_COMP_BYTEBIT 1
#define RIPC_COMP_TYPE 2

static u8 ripccompressions[][3]	=	{	0, 0x00, RIPC_COMP_NONE,	/* no compression	*/
										0, 0x01, RIPC_COMP_ZLIB,	/* zlib compression	*/
										0, 0x02, RIPC_COMP_LZ4 };	/* LZ4 compression	*/
