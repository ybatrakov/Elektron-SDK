...
#endif	/* DEV_LITTLE_ENDIAN */


#ifdef DEV_QUAD_32_ALIGN
#define move_u16(d,s) \
	((char*)(d))[0] = ((char*)(s))[0];\
	((char*)(d))[1] = ((char*)(s))[1]
#define move_u32(d,s) \
...
#define _move_u32_swap(d,s) \
	...
	((char*)(d))[2] = ((char*)(s))[2];\
	((char*)(d))[3] = ((char*)(s))[3]
#endif /* if DEV_LITTLE_ENDIAN */
	
#else /* not DEV_QUAD_32_ALIGN */
#ifdef DEV_LITTLE_ENDIAN
#define _move_u16_swap(d,s) \
	((char*)(d))[0] = ((char*)(s))[1];\
	((char*)(d))[1] = ((char*)(s))[0]
