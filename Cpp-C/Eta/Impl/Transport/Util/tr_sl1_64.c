...
rtrInt32 Decrypt_TR_SL1_64(const rtrUInt8* pSharedKey, const RwfBuffer *pEncryptedInput, RwfBuffer *pDecryptedOutput) 
{
	...
	// Perform decryption
	// TODO: could I do this right into the output buffer?  
	...
	if((iTemp < 0) || (iTemp > (pEncryptedInput->length - (rtrInt32)(sizeof(rtrUInt32)+(sizeof(rtrUInt32)+4)))))
		return -6;
	...
	if (pDecryptedOutput->length < iTemp)
		return -7;
