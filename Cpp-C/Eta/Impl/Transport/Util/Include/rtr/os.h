...
#ifdef __sparc	
	#define RTR_BIG_ENDIAN
	#define RTR_QUAD_32_ALIGN
	/* 64b sparc requires 8-byte alignment for 64b pointers*/
	#ifdef _LP64
		#define RTR_DWORD_ALIGN_BITS 0x7
	#else
...
/* Platform specific definitions for Sun 32 and 64-bit */
#if defined(sun4) || defined(i86pc) || defined(__sun)
